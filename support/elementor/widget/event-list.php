<?php
namespace MEPPluginCustom\Widgets;
...
class MEPEventListCustomWidget extends Widget_Base {

	public function get_name() {
		return 'mep-event-list-widget-anokijig';
	}

	public function get_title() {
		return __( 'Event List Anokijig', 'anokijig-custom' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Event List', 'anokijig-custom' ),
			]
		);
		...
		$this->add_control(
			'mep_event_list_cat',
			[
				'label' => __( 'Category', 'anokijig-custom' ),
		...
		$this->add_control(
			'mep_event_list_org',
			[
				'label' => __( 'Organizer', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => '0',
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'List Style', 'anokijig-custom' ),
				'type' 			=> Controls_Manager::SELECT,
				'default' 		=> 'grid',				
				'options' 		=> [
					'grid' 		=> __( 'Grid', 'anokijig-custom' ),
					'list' 		=> __( 'List', 'anokijig-custom' ),
					'minimal' 	=> __( 'Minimal', 'anokijig-custom' ),
					'native' 	=> __( 'Native', 'anokijig-custom' ),
					'timeline' 	=> __( 'Timeline', 'anokijig-custom' ),
					'title' 	=> __( 'Title Only', 'anokijig-custom' ),
					'spring' 	=> __( 'Spring', 'anokijig-custom' ),
					'winter' 	=> __( 'Winter', 'anokijig-custom' ),
				],			
				'separator' 	=> 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Column', 'anokijig-custom' ),
				'type' 			=> Controls_Manager::SELECT,
				'default' 		=> '3',				
				'options' 		=> [
					'1' => __( '1', 'anokijig-custom' ),
					'2' => __( '2', 'anokijig-custom' ),
					'3' => __( '3', 'anokijig-custom' ),
					'4' => __( '4', 'anokijig-custom' )
				],			
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Filter', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'no',
				'options' => [
					'yes' => __( 'Yes', 'anokijig-custom' ),
					'no' => __( 'No', 'anokijig-custom' )
				],		
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Organizer Filter', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'no',
				'options' => [
					'yes' => __( 'Yes', 'anokijig-custom' ),
		...
		$this->add_control(
			'mep_event_list_show',
			[
				'label' => __( 'No of Item Show', 'anokijig-custom' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '10', 'anokijig-custom' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Pagination', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'no',
				'options' => [
					'yes' => __( 'Yes', 'anokijig-custom' ),
					'carousal' => __( 'Carousal', 'anokijig-custom' ),
					'no' => __( 'No', 'anokijig-custom' )
				],			
				'separator' => 'none',
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Carousal Unique ID', 'anokijig-custom' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '102448', 'anokijig-custom' ),
			]
		);		
		$this->add_control(
			'mep_event_list_carousal_nav',
			[
				'label' => __( 'Carousal Navigation', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'no',
				'options' => [
					'yes' => __( 'Yes', 'anokijig-custom' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Carousal Dot', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'yes',
				'options' => [
					'yes' => __( 'Yes', 'anokijig-custom' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Timeline Style', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'vertical',
				'options' => [
					'vertical' => __( 'Vertical', 'anokijig-custom' ),
					'horizontal' => __( 'Horizontal', 'anokijig-custom' )
		...
		$this->add_control(
			'mep_event_list_sort',
			[
				'label' => __( 'Sort', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'ASC',
				'options' => [
					'ASC' => __( 'Assending', 'anokijig-custom' ),
					'DESC' => __( 'Dessending', 'anokijig-custom' )
		...
		$this->add_control(
			...
			[
				'label' => __( 'Status', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'upcoming',
				'options' => [
					'upcoming' => __( 'Upcoming', 'anokijig-custom' ),
					'expired' => __( 'Expired', 'anokijig-custom' )
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show Thumbnail', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'block',
				'options' => [
					'block' => __( 'Yes', 'anokijig-custom' ),
					'none' => __( 'No', 'anokijig-custom' )
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show Ribbon', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flex',
				'options' => [
					'flex' => __( 'Yes', 'anokijig-custom' ),
					'none' => __( 'No', 'anokijig-custom' )
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show View More Date Button', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'inline',
				'options' => [
					'inline' => __( 'Yes', 'anokijig-custom' ),
					'none' => __( 'No', 'anokijig-custom' )
		...
		$this->add_control(
			'mep_event_show_date',
			[
				'label' => __( 'Show Date', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'block',
				'options' => [
					'block' => __( 'Yes', 'anokijig-custom' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __( 'Border Radius', 'anokijig-custom' ),
		...
		$this->add_control(
			'mep_date_bg_color',
			[
				'label' => __( 'Background Color', 'anokijig-custom' ),
		...
		$this->add_control(
			'mep_date_text_color',
			[
				'label' => __( 'Text Color', 'anokijig-custom' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Title', 'anokijig-custom' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show Title', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'block',
				'options' => [
					'block' => __( 'Yes', 'anokijig-custom' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Border Color', 'anokijig-custom' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [				
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Price', 'anokijig-custom' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show Price', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'block',
				'options' => [
					'block' => __( 'Yes', 'anokijig-custom' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Event Information List', 'anokijig-custom' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'mep_event_show_info',
			[
				'label' => __( 'Show Event Info', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'block',
				'options' => [
					'block' => __( 'Yes', 'anokijig-custom' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show Organiztion?', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flex',
				'options' => [
					'flex' => __( 'Yes', 'anokijig-custom' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show Location?', 'anokijig-custom' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flex',
				'options' => [
					'flex' => __( 'Yes', 'anokijig-custom' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Icon Background Color', 'anokijig-custom' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [				
		...
		$this->add_control(
			...
			[
				'label' => __( 'Icon Color', 'anokijig-custom' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [				
		...
		$this->add_control(
			...
			[
				'label' => __( 'Thumbnail Border Color', 'anokijig-custom' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [				
		...
		$this->add_control(
			...
			[
				'label' => __( 'List Background Color', 'anokijig-custom' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [				
		...
		$this->add_control(
			...
			[
				'label' => __( 'Ribbon Background Color', 'anokijig-custom' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [				
		...
		$this->start_controls_section(
			'mep_event_btn_style',
			[
				'label' => __( 'Button Style', 'anokijig-custom' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
...
<div class="mep-elementor-event-list-widget">
		<?php echo do_shortcode("[event-list-custom cat='$cat' org='$org' style='$style' column='$column' cat-filter='$cat_filter' org-filter='$org_filter' show='$show' pagination='$pagination' carousal-nav='$carousal_nav' carousal-dots='$carousal_dot' carousal-id='$carousal_id' timeline-mode='$timeline_style' sort='$sort' status='$status']"); ?>
</div>
<?php
}
}
